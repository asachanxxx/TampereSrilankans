...
const stageStyle: Record<string, string> = {
  ...
  paid_bonus: "bg-teal-50 text-teal-700 border-teal-200",
...
export function EventManagementMyTicketsTab({ eventId, currentUserId, paymentInstructions }: Props) {
                    ...
                    {stage === "payment_sent" && (
                      <>
                        ...
                        >
                          ...
                          {ticket.reminderCount > 0 ? `Reminder (${ticket.reminderCount})` : 'Payment Reminder'}
                        </Button>
                        <Button
                          size="sm"
                          variant="outline"
